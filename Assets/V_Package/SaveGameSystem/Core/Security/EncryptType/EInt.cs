...
{
    [Serializable]
    public struct EInt : IObscuredType, IFormattable, IEquatable<EInt>, IComparable<EInt>, IComparable<int>, IComparable
    {
        //private ObscuredInt obscured;
		...
		public static EInt FromEncrypted(int encrypted, int key)
		{
			var instance = new EInt();
		...
		private static EInt Increment(EInt input, int increment)
		{
		...
		{
			return obj is EInt && Equals((EInt)obj);
		}

		public bool Equals(EInt obj)
		{
		...
		public int CompareTo(EInt other)
		{
