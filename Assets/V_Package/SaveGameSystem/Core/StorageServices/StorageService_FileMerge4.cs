...
{
    public class StorageService_FileMerge4 : StorageService
    {
        //Don't change this!!!
        private static readonly string rootFolderPathFormat = "SaveGame/FileMerge4/db.{0}";
        ...
        public override void OpenService(Database database)
        {
            ...
            {
                dictFileContent = SGJson.Parse(File_ReadAllText(filePath_Database));
            }
            else
            {
